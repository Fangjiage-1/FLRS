#!/usr/bin/env bash
# ===========================================================================
# ELF evaluation — Adaptive Heun (variable step size)
#   Every step: Heun (2 NFE) + free error estimate from |v2 - v1|
#   Error > tol*h → subdivide → more steps near t→1
#   NFE: 2×base_steps + extra subdivisions where dynamics are stiff
# ===========================================================================
set -euo pipefail
...
OUTPUT_DIR=${OUTPUT_DIR:-"outputs/elf_b-owt_heun_adaptive_leCun_eval"}
...
SAMPLING_CONFIG="src/configs/sampling_configs/heun_adaptive_sampling_configs.yml"

echo "============================================================"
echo " ELF Adaptive Heun Evaluation"
echo "============================================================"
echo " GPUs:               $NGPU"
