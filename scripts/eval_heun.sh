#!/usr/bin/env bash
# ===========================================================================
# ELF evaluation — pure Heun (2nd-order Runge-Kutta on velocity field)
# ===========================================================================
set -euo pipefail
...
OUTPUT_DIR=${OUTPUT_DIR:-"outputs/elf_b-owt_heun_eval"}
...
SAMPLING_CONFIG="src/configs/sampling_configs/heun_sampling_configs.yml"

echo "============================================================"
echo " ELF Heun Evaluation (velocity-field RK2)"
echo "============================================================"
echo " GPUs:               $NGPU"
