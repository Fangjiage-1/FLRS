#!/usr/bin/env bash
# ===========================================================================
# ELF evaluation — Exponential Integrator (solves linear part analytically)
# ===========================================================================
set -euo pipefail
...
OUTPUT_DIR=${OUTPUT_DIR:-"outputs/elf_b-owt_exp_heun_eval"}
...
SAMPLING_CONFIG="src/configs/sampling_configs/exp_heun_sampling_configs.yml"

echo "============================================================"
echo " ELF exp-Heun Evaluation (exponential integrator)"
echo "============================================================"
echo " GPUs:               $NGPU"
