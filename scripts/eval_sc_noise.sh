#!/usr/bin/env bash
# ===========================================================================
# ELF evaluation — Self-conditioning noise (LeWM-inspired)
#   Perturb x_pred input, not z. Noise decays as (1-t)² → 0 at t→1.
#   0 extra NFE.
# ===========================================================================
set -euo pipefail
...
SEEDS=${SEEDS:-"42"}
OUTPUT_DIR=${OUTPUT_DIR:-"outputs/elf_b-owt_sc_noise_v2_eval"}
...
SAMPLING_CONFIG="src/configs/sampling_configs/sc_noise_sampling_configs.yml"

echo "============================================================"
echo " ELF Self-Conditioning Noise Evaluation (fixed)"
echo "   sc_noise_scale: perturbs x_pred input"
echo "============================================================"
echo " GPUs:               $NGPU"
