#!/usr/bin/env bash
# ===========================================================================
# ELF-B XSum conditional generation evaluation
# ===========================================================================
set -euo pipefail
...
SEEDS=${SEEDS:-"42"}
OUTPUT_DIR=${OUTPUT_DIR:-"outputs/elf_b-xsum_eval"}
CHECKPOINT=${CHECKPOINT:-"embedded-language-flows/ELF-B-xsum-torch"}
...
TRAIN_CONFIG="src/configs/training_configs/train_xsum_ELF-B.yml"
SAMPLING_CONFIG="src/configs/sampling_configs/xsum_sampling_configs.yml"

echo "============================================================"
echo " ELF-B XSum Summarization Evaluation"
echo "============================================================"
echo " GPUs:               $NGPU"
