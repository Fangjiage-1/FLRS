#!/usr/bin/env bash
# ===========================================================================
# ELF evaluation — Multi-Langevin SDE (sde_ml)
#   Each step: k rounds of {add noise → denoise via exp}
#   Independent noise per round → denser stochastic correction
...
OUTPUT_DIR=${OUTPUT_DIR:-"outputs/elf_b-owt_sde_ml_eval"}
...
SAMPLING_CONFIG="src/configs/sampling_configs/sde_ml_sampling_configs.yml"

echo "============================================================"
echo " ELF Multi-Langevin SDE Evaluation"
echo "============================================================"
echo " GPUs:               $NGPU"
