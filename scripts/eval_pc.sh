#!/usr/bin/env bash
# ===========================================================================
# ELF evaluation — PC sampler (Predictor-Corrector)
#   Predictor: exp (deterministic step)
#   Corrector:  noise injection + denoise (stochastic correction)
#   2 NFEs / step
# ===========================================================================
set -euo pipefail
...
OUTPUT_DIR=${OUTPUT_DIR:-"outputs/elf_b-owt_pc_eval"}
...
SAMPLING_CONFIG="src/configs/sampling_configs/pc_sampling_configs.yml"

echo "============================================================"
echo " ELF PC Sampler Evaluation (Predictor-Corrector)"
echo "============================================================"
echo " GPUs:               $NGPU"
